...
enum GeneratorError: Error, CustomStringConvertible {
  ...
  var description: String {
    ...
    case .invalidKey: "The API key must begin with sk-ant-."
...
func securelyReadKey() throws -> String {
  ...
  guard trimmed.hasPrefix("sk-ant-") else { throw GeneratorError.invalidKey }
  return trimmed
}
...
do {
  ...
  let payload = "v1.\(hex(mask)).\(hex(ciphertext))"
